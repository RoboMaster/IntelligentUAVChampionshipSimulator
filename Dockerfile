...
# ADD Build /usr/local/
ADD https://stg-robomasters-hz-q0o2.oss-cn-hangzhou.aliyuncs.com/rmua2025-stu-v1.0.zip /usr/local/
RUN cd /usr/local/ && unzip -o rmua2025-stu-v1.0.zip && mv Build/LinuxNoEditor /usr/local/
