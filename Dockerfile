...
# ADD Build /usr/local/
ADD https://stg-robomasters-hz-q0o2.oss-cn-hangzhou.aliyuncs.com/RMUA20241209.zip /usr/local/
RUN cd /usr/local/ && unzip -o RMUA20241209.zip && mv Build/LinuxNoEditor /usr/local/
