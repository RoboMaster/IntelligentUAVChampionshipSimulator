...
3. ## 下载资源文件到特定位置
   ...
   ---
   >`wget -O ./stage1_stereo/contest2/Content/Paks/contest2-LinuxNoEditor.pak  https://stg-robomasters-hz-q0o2.oss-cn-hangzhou.aliyuncs.com/simulator/stage1/contest2-LinuxNoEditor.pak`
   ---
   >`wget -O ./stage1_stereo/contest2/Binaries/Linux/contest2 https://stg-robomasters-hz-q0o2.oss-cn-hangzhou.aliyuncs.com/simulator/stage1/contest2`
